...
public class TelaTelefone {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					if (table.getSelectedRow() >= 0) {
						//copiar o telefone selecionado para formulario de edicao
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					textField_3.setText("");
					FachadaTelefone.criarTelefone(telefone,nome);
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					FachadaTelefone.alterarNumero(numero1, numero2);
	...
	public void listagem () {
		try{
			List<Telefone> lista = FachadaTelefone.listarTelefones(textField.getText());
